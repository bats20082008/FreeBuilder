...
public class DefaultedPropertiesSourceTest {
  ...
  public void testJ6() {
    ...
    assertThat(generateSource(metadata, GuavaLibrary.AVAILABLE)).isEqualTo(Joiner.on('\n').join(
        ...
        "    Person_Builder _emptyTemplate = new Person.Builder();",
        "    if (!value.getName().equals(_emptyTemplate.getName())) {",
        "      setName(value.getName());",
        "    }",
        "    if (value.getAge() != _emptyTemplate.getAge()) {",
        "      setAge(value.getAge());",
        "    }",
        "    return (Person.Builder) this;",
        "  }",
        ...
        "    Person_Builder _emptyTemplate = new Person.Builder();",
        "    if (!template.getName().equals(_emptyTemplate.getName())) {",
        "      setName(template.getName());",
        "    }",
        "    if (template.getAge() != _emptyTemplate.getAge()) {",
  ...
  public void testOneDefaultProperty_noGuava_j6() {
    ...
    assertThat(generateSource(metadata)).isEqualTo(Joiner.on('\n').join(
        ...
        "  public Person.Builder mergeFrom(Person value) {",
        "    Person_Builder _emptyTemplate = new Person.Builder();",
        "    if (_emptyTemplate._unsetProperties.contains(Person_Builder.Property.NAME)",
        "        || !value.getName().equals(_emptyTemplate.getName())) {",
        "      setName(value.getName());",
        "    }",
        "    if (value.getAge() != _emptyTemplate.getAge()) {",
        "      setAge(value.getAge());",
        "    }",
        "    if (_emptyTemplate._unsetProperties.contains(Person_Builder.Property.SHOE_SIZE)",
        "        || value.getShoeSize() != _emptyTemplate.getShoeSize()) {",
        ...
        "        && (_emptyTemplate._unsetProperties.contains(Person_Builder.Property.NAME)",
        "            || !template.getName().equals(_emptyTemplate.getName()))) {",
        "      setName(template.getName());",
        "    }",
        "    if (template.getAge() != _emptyTemplate.getAge()) {",
        "      setAge(template.getAge());",
        ...
        "        && (_emptyTemplate._unsetProperties.contains(Person_Builder.Property.SHOE_SIZE)",
        "            || template.getShoeSize() != _emptyTemplate.getShoeSize())) {",
  ...
  private static Metadata createMetadata() {
    ...
    return new Metadata.Builder()
        ...
        .setPartialType(generatedBuilder.nestedType("Partial").withParameters())
        .addProperties(name
            .setCodeGenerator(new DefaultPropertyFactory.CodeGenerator(name.build(), true))
            .build())
        .addProperties(age
            .setCodeGenerator(new DefaultPropertyFactory.CodeGenerator(age.build(), true))
            .build())
        .setPropertyEnum(generatedBuilder.nestedType("Property").withParameters())
        .setType(person.withParameters())
        .setValueType(generatedBuilder.nestedType("Value").withParameters())
