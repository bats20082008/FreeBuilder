...
public class ListSourceTest {
  ...
  public void test_guava_j6() {
    ...
    assertThat(generateSource(metadata, GuavaLibrary.AVAILABLE)).isEqualTo(Joiner.on('\n').join(
        ...
        "    if (name == ImmutableList.<String>of() && base.name instanceof ImmutableList) {",
        "      name = base.name;",
        "    } else {",
        "      addAllName(base.name);",
        "    }",
        "    if (age == ImmutableList.<Integer>of() && base.age instanceof ImmutableList) {",
        "      age = base.age;",
        "    } else {",
        "      addAllAge(base.age);",
        "    }",
