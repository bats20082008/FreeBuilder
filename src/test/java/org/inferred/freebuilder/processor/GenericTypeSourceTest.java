...
public class GenericTypeSourceTest {
  ...
  public void testJ6() {
    ...
    assertThat(generateSource(metadata, GuavaLibrary.AVAILABLE)).isEqualTo(Joiner.on('\n').join(
        ...
        "    Person_Builder<A, B> _emptyTemplate = new Person.Builder<A, B>();",
        "    if (_emptyTemplate._unsetProperties.contains(Person_Builder.Property.NAME)",
        "        || !value.getName().equals(_emptyTemplate.getName())) {",
        "      setName(value.getName());",
        "    }",
        "    if (_emptyTemplate._unsetProperties.contains(Person_Builder.Property.AGE)",
        "        || !value.getAge().equals(_emptyTemplate.getAge())) {",
        "      setAge(value.getAge());",
        "    }",
        "    return (Person.Builder<A, B>) this;",
        "  }",
        ...
        "        && (_emptyTemplate._unsetProperties.contains(Person_Builder.Property.AGE)",
        "            || !template.getAge().equals(_emptyTemplate.getAge()))) {",
  ...
  public void testJ7() {
    ...
    assertThat(source).isEqualTo(Joiner.on('\n').join(
        ...
        "   */",
        "  public Person.Builder<A, B> mergeFrom(Person<A, B> value) {",
        "    Person_Builder<A, B> _emptyTemplate = new Person.Builder<>();",
        "    if (_emptyTemplate._unsetProperties.contains(Person_Builder.Property.NAME)",
        "        || !value.getName().equals(_emptyTemplate.getName())) {",
        "      setName(value.getName());",
        "    }",
  ...
  private static Metadata createMetadata() {
    ...
    return new Metadata.Builder()
        ...
        .addProperties(name
            .setCodeGenerator(new DefaultPropertyFactory.CodeGenerator(name.build(), false))
            .build())
        .addProperties(age
            .setCodeGenerator(new DefaultPropertyFactory.CodeGenerator(age.build(), false))
            .build())
